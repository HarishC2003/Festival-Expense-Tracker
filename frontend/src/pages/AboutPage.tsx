        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-display font-bold text-[#F7F7F7] tracking-tight">
              ...
              <div className="md:col-span-4 space-y-6">
                <div className="bg-[#111] border border-white/10 rounded-2xl p-6 shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="flex flex-col gap-3 relative z-20">
                    <Button 
                      type="button"
                      onClick={() => window.open("https://www.linkedin.com/in/harish-c-sh", "_blank")}
                      variant="outline" 
                      className="w-full justify-start border-white/10 hover:border-[#D4AF37]/50 hover:bg-[#D4AF37]/10 hover:text-[#D4AF37] transition-all bg-[#0a0a0a]"
                    >
                    ...
                    <Button 
                      type="button"
                      onClick={() => window.open("https://github.com/HarishC2003", "_blank")}
                      variant="outline" 
                      className="w-full justify-start border-white/10 hover:border-[#D4AF37]/50 hover:bg-[#D4AF37]/10 hover:text-[#D4AF37] transition-all bg-[#0a0a0a]"
                    >
                    ...
                    <Button 
                      type="button"
                      onClick={() => window.open("https://harishc2003.github.io/Portfolio/", "_blank")}
                      variant="outline" 
                      className="w-full justify-start border-white/10 hover:border-[#D4AF37]/50 hover:bg-[#D4AF37]/10 hover:text-[#D4AF37] transition-all bg-[#0a0a0a]"
                    >
